...
**Infrastructure Engineer · AI/ML Practitioner**<br/>
**인프라 엔지니어 · AI/ML 실무자**
...
13+ years of hands-on experience in IT infrastructure — networking, server systems, security solutions, and Linux operations across enterprise environments.

Completed an AI/ML bootcamp to build formal skills in machine learning and modern software development. Currently works at the intersection of infrastructure operations and AI-assisted development, applying "vibe coding" practices to build practical automation tools that bridge both domains.
...
**Network**<br/>
Cisco · Fortinet · HPE Aruba · F5 · Alteon · GNS3

**Server & OS**<br/>
HPE · Dell EMC · SuperMicro · CentOS · Rocky Linux · Ubuntu

**AI / ML**<br/>
PyTorch · YOLO · OpenCV · scikit-learn · pandas · Hugging Face

**RAG / LLM**<br/>
LangChain · ChromaDB · FastAPI · Streamlit · Ollama

**Languages & Tools**<br/>
Python · Bash · C++ · JavaScript/TypeScript · Docker · Git
...
기업 환경의 네트워크·서버·보안 솔루션·Linux 운영을 중심으로 13년 이상의 실무 경험을 보유하고 있음.

AI/ML 부트캠프를 수료하여 머신러닝 및 최신 소프트웨어 개발 역량을 체계적으로 쌓았음. 현재는 인프라 운영과 AI 기반 개발의 교차점에서 "바이브 코딩" 방식으로 두 영역을 잇는 실용적인 자동화 도구를 만들고 있음.
